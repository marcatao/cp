...
<div class="bg-green-light">
    ...
    <div class="row">
    <div class="col-md-4">
        <img src="{{asset('img/educacional/integral_1.jpg')}}" alt="" class="img-fluid">
    </div>
    <div class="col-md-4 d-flex flex-column justify-content-center mt-5 mb-5">
        <h5>+ CICLO COMPLETO DE ATIVIDADES</h5>
        <h5>+ PROPOSTA PEDAGÓGICA DIFERENCIADA</h5>
        <h5>+ GRUPOS POR FAIXA ETÁRIA</h5>
    </div>
    <div class="col-md-4">
        <img src="{{asset('img/educacional/integral_2.jpg')}}" alt="" class="img-fluid">
    </div>
    </div>
    </div>
</div>
