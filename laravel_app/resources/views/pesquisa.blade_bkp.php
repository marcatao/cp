                ...
                {{  csrf_field() }}
                    ...
                    <div class="form-group">
                      ...
                      <select class="form-control" id="dia_prova" name="dia_prova" required>
                        <option value=""></option>
                        <option value="Online - 02/09/20">Online - 02/09/20</option>
                        <option value="Presencial - 03/09/20">Presencial - 03/09/20</option>
                      </select>
                    </div>         
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-11">
                        <label for="de_acordo">Li e concordo com os termos do regulamento: 
                          <a href="https://colegioparaisosbc.com.br/pdfs/regulamento_desafio_paraiso_2021.pdf">
                            https://colegioparaisosbc.com.br/pdfs/regulamento_desafio_paraiso_2021.pdf</a>
                         </label>
...
$(document).ready(function() {
    $('#upload').bind("click",function(){ 
        ...
        if(imgVal==''){ 
            alert("O campo boletin 2019 é obrigatório"); 
            return false; 
        } 
    }); 
});
